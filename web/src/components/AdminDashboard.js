...
const AdminDashboard = () => {
    ...
    const createAndSendNFT = async (e) => {
        ...
        try {
            ...
            let newTokenId = null;
            const mintTransferEvent = mintReceipt.logs.find(log => 
                log.address.toLowerCase() === CONTRACT_ADDRESS.toLowerCase()
            );
            
            if (mintTransferEvent && mintTransferEvent.topics && mintTransferEvent.topics[3]) {
                newTokenId = parseInt(mintTransferEvent.topics[3], 16);
                console.log('🏷️ Token ID:', newTokenId);
            }
            
            setMessage(`✅ NFT #${newTokenId || 'mới'} đã được tạo và gửi thành công!\n🎯 Người nhận: ${formData.recipientAddress}\n📋 TX: ${mintTx.hash}`);
                ...
                <div className="access-denied">
                    <div className="denied-card">
                        ...
                        <div className="access-info">
                            ...
                            <p><strong>Yêu cầu địa chỉ contract owner:</strong></p>
