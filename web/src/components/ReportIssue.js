...
import "./MyNFTs.css";      // dùng chung layout & button
import "./ReportIssue.css"; // style riêng cho form báo cáo
...
const ReportIssue = () => {
  ...
  // Load tracked report IDs from localStorage
  useEffect(() => {
    try {
  ...
  // Poll trạng thái các report đã gửi
  useEffect(() => {
  ...
  return (
    <div className="mynft-container report-page">
      <div className="report-issue">
        <div className="report-container">
          {/* HEADER – dùng chung style với MyNFTs / Marketplace */}
          <div className="mynft-header-card">
            ...
            <div className="mynft-wallet-box report-box">
              <div className="wallet-label">Trạng thái</div>
              <div className="wallet-address">
                {myReports.length > 0
                  ? `Bạn đang theo dõi ${myReports.length} báo cáo`
                  : "Chưa có báo cáo nào"}
              </div>
          ...
          <div className="report-lookup">
            ...
            <form onSubmit={lookup} className="lookup-form">
              ...
              />
              <button type="submit" className="mynft-btn secondary">
                Tra cứu
              </button>
            </form>
